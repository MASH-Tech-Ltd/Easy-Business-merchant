      ...
      <div className="relative hidden lg:flex flex-1 flex-col justify-center items-end p-16 xl:p-24 overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 w-full max-w-xl">
          ...
          <p className="text-lg text-gray-300 mb-12 leading-relaxed max-w-md">
            Join the premier multi-tenant platform designed specifically for electronics merchants. Scale your sales, manage inventory, and grow your brand.
          </p>
          ...
          <div className="flex flex-col gap-4 text-gray-300">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-sm">Built for Rising Businesses</span>
                <span className="text-xs text-gray-400">Everything you need to scale your electronics brand.</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center lg:items-start p-6 sm:p-12 lg:p-16 xl:p-24 relative">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-500 text-sm">Please enter your details to sign in to your dashboard.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot" className="text-xs text-[hsl(var(--accent-primary))] font-semibold hover:text-[hsl(var(--accent-primary))]/80 transition-colors">Forgot password?</Link>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <p className="text-center text-sm text-gray-500">
              ...
              <Link href="/register" className="text-[hsl(var(--accent-primary))] font-semibold hover:underline">
                Create one now
              </Link>
            </p>
          </div>
